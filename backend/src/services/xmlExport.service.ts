...
const POLICY_TYPE_CODE: Record<string, string> = {
  'ชั้น 1': '01', 'ประเภท 1': '01',
  'ชั้น 2': '02', 'ประเภท 2': '02',
  'ชั้น 3': '03', 'ประเภท 3': '03',
  // กลุ่ม "พลัส" = กรมธรรม์ประเภท 5 → รหัสขึ้นต้น 5 ตามด้วยชั้นย่อย
  'ชั้น 2+': '52', 'ประเภท 2+': '52',   // ✅ ยืนยันจากใบจริง
  // ⛔ ห้ามเดา "ชั้น 3+" เป็น 53 — เคยใส่ไว้แล้วถอดออก (13/08/69) ยังไม่มีใบ 3+ มายืนยัน
  //    ช่องนี้เป็นช่องพิมพ์แล้วทั้งแอปและเว็บ พนักงานคีย์รหัสตามใบได้ตรง ๆ ไม่ต้องให้ระบบเดา
  //    ส่งรหัสผิดเข้าระบบประกันเงียบ ๆ แย่กว่าส่งข้อความตามที่คนกรอก
};
