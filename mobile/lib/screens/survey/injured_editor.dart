  ...
  Widget build(BuildContext context) {
    return EditorScaffold(
      ...
      children: [
        ...
        kText(_ctl('name'), 'ชื่อ-นามสกุลผู้บาดเจ็บ', req: true),
        kRow2(kNum(_ctl('age'), 'อายุ'), kText(_ctl('cid'), 'เลขบัตร/พาสปอร์ต', req: true)),
        kText(_ctl('car_reg'), 'เลขทะเบียนรถ (ของผู้บาดเจ็บ)', req: true),
        ...
        kSubhead('การรักษา'),
        kText(_ctl('hospital'), 'เข้ารักษาที่โรงพยาบาล', req: true),
        kRow2(KDateField(_ctl('treat_from'), 'เข้ารักษาวันที่', yearsAhead: 0), KDateField(_ctl('treat_to'), 'ถึงวันที่', yearsAhead: 0)),
