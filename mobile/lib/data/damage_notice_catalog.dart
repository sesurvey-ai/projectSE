...
const Map<String, InsurerFooter> kInsurerFooters = {
  ...
  '1059': InsurerFooter(
    lines: [
      // ⛔ **ไอโออิถอดบรรทัด "*** กรุณาติดต่อบริษัทฯภายใน 7 วัน" ออกแล้ว**
      //    (user ยืนยัน 27/08/69 · ใบจริงที่พิมพ์จากระบบวันนั้น 4 ใบไม่มีสักใบ
      //     ส่วนใบเดือน ม.ค. ยังมีอยู่ = เขาเลิกใช้ระหว่างทาง)
      //    ⚠️ เฉพาะไอโออิ — ไทยไพบูลย์ยังมี "ภายใน 15 วัน" อยู่
