...
const DEFAULT_SHIFT_COLORS: Record<string, string> = { s1: '#13A06B', s2: '#E0991A', s3: '#6366E8', off: '#141414' };
...
.d2 {
  ...
  --off-tint:#141414; --off-ink:#FFFFFF; --off-solid:#141414; --off-strong:#141414;
