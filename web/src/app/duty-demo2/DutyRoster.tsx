...
const DEFAULT_SHIFT_COLORS: Record<string, string> = { s1: '#13A06B', s2: '#E0991A', s3: '#6366E8', off: '#222426' };
...
.d2 {
  ...
  --off-tint:#222426; --off-ink:#FFFFFF; --off-solid:#222426; --off-strong:#222426;
