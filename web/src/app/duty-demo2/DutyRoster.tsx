...
const DEFAULT_SHIFT_COLORS: Record<string, string> = { s1: '#13A06B', s2: '#E0991A', s3: '#6366E8', off: '#1a1c1e' };
...
.d2 {
  ...
  --off-tint:#1a1c1e; --off-ink:#FFFFFF; --off-solid:#1a1c1e; --off-strong:#1a1c1e;
