...
const DEFAULT_SHIFT_COLORS: Record<string, string> = { s1: '#13A06B', s2: '#E0991A', s3: '#6366E8', off: '#000000' };
...
.d2 {
  ...
  --off-tint:#000000; --off-ink:#FFFFFF; --off-solid:#000000; --off-strong:#000000;
